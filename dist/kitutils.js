(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["kitutils"] = factory();
	else
		root["kitutils"] = factory();
})(this, function() {
...
/***/ function(module, exports) {
	...
	var set = exports.set = partial(function (obj, path, val) {
	    var keys = path.split(".").map(function (item) {
	        return (m = item.match(/\w+/g)).length === 1 ? m[0] : m;
	    });
	    reduce(function (prev, cur, idx, list) {
	        if (idx === list.length - 1) {
	            if (isArray(cur)) {
	                var ret = reduce(function (p, c) {
	                    return p[c];
	        ...
	        return isArray(cur) ? reduce(function (p, c) {
	            return p[c];
